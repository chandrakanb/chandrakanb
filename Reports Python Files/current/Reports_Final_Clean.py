    ...
    for version in ["2.3", "2.4"]:
        ...
        if version == "2.3":
            HTML_2_3 = (
                ...
                f"<tr><td style='border: 1px solid black;'>Total Test Script</td><td style='border: 1px solid black;'>{test_script_total}</td></tr>"
                f"<tr><td style='border: 1px solid black;'>Pass</td><td style='border: 1px solid black;'>{test_script_pass}</td></tr>"
                f"<tr><td style='border: 1px solid black;'>Fail</td><td style='border: 1px solid black;'>{test_script_fail}</td></tr>"
                f"<tr><td style='border: 1px solid black;'>Verify Manually</td><td style='border: 1px solid black;'>{test_script_verify_manually}</td></tr>"
                "</table><br>"
            )

...
API_TOKEN = "ATATT3xFfGF02KYGPNi5I-QhOBzzdKl4fGPbzT-O_XuBVavlxMy93kYim6wzLjOpXrYMjPrCwWuLRTsvnHaE5EKuJzPQMo9m4PiZPnrvTQejgFgQ7QlnIfH0hJRx4wBTndoPM5eNk1odD_jFoDDst_Mzmap3-ivEdTJomlQlBCfLyeN7l4YLGVc=381A8FB0"

JQL = 'project = CNT AND issuetype = "Test Cases" AND status in ("TS L1 REWORK RE-OPENED", "TS L1 REWORK REQUIRED", "TS L2 REWORK RE-OPENED", "TS L2 REWORK REQUIRED", "TS L3 REWORK RE-OPENED", "TS L3 REWORK REQUIRED") AND labels = CNT_Finalized_26PF'
...
df.to_excel("jira_test_cases_with_children_and_status.xlsx", index=False)

print("✅ Excel file 'jira_test_cases_with_children_and_status.xlsx' created successfully.")

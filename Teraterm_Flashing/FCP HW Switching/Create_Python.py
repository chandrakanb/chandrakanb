...
for index, row in df.iterrows():
    ...
    script_name  = f"{VariantCode}.py"
    hw_variant = row['hw_variant']
    fcp_switch_command = row['fcp_switch_command']
...
def launch_teraterm(com_port):
    try:
        ...
        subprocess.Popen([r"C:\Program Files (x86)\teraterm\ttermpro.exe", f'/C={com_port1}', '/BAUD=115200'])
...
if __name__ == "__main__":
    ...
    fcp_switch_command = "{fcp_switch_command}"

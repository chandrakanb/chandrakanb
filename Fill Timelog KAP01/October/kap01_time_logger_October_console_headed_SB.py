...
# === TASK CONFIGURATION ===
tasks = [
    {"url": "https://kap01.kpit.com/kap/issues/374857/time_entries/new", "hours": "4", "comment": "Automation Test Execution", "work_category": "TEST AUTOMATION", "work_type": "WORK"},
    {"url": "https://kap01.kpit.com/kap/issues/374865/time_entries/new", "hours": "2", "comment": "Test Script Development", "work_category": "TEST AUTOMATION", "work_type": "WORK"},
    {"url": "https://kap01.kpit.com/kap/issues/374869/time_entries/new", "hours": "2", "comment": "Test Script Development Internal Rework", "work_category": "TEST AUTOMATION", "work_type": "INTERNAL REWORK"},
    {"url": "https://kap01.kpit.com/kap/issues/374863/time_entries/new", "hours": "1", "comment": "Automation-Meeting/Trainings", "work_category": "TEAM MEETING", "work_type": ""}
]
...
if __name__ == "__main__":
    ...
    username = "SAHILB@KPIT.COM"
    password = "S@hil@123456789"
    ...
    try:
        ...
        time.sleep(10)
        user_input = input("Enter to proceed: ")

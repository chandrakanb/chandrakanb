...
def open_excel_and_wait(file_path):
    ...
    try:
        ...
        # Wait for the user to close the Excel application
        process.communicate()  # This will wait until the process is completed
        
        print("Excel file closed. Proceeding with the next steps.")
...
if __name__ == "__main__":
    ...
    # Ensure the file exists and Open the Excel file     
    if os.path.exists(excel_file_path):
        open_excel_and_wait(excel_file_path)
    else:

...
TOKEN = "OTI4ODIzNTkxMDU3OqXjifLIZb4PU1slc2DBCcLaeTM2" #"NzQxMjAwNTgyMDk0OiRFVmuHryirO4VhnR1/V6mhxvi6" #os.getenv("JIRA_TOKEN")
...
AVAILABLE_FOLDERS = [
    "/PF 23/A14/AEC1413S0.260227.1/iPhone 16 Pro",
    "/PF 23/A14/AEC1413S0.260227.1/Google Pixel 9",
    "/PF 23/A14/AEC1413S0.260227.1/Samsung S25 Ultra"
]
...
def show_create_screen():
    ...
    with st.form("create_cycle_form"):
        ...
        with col2:
            ...
            iterations = st.number_input("Number of Iterations*", min_value=1, max_value=50, value=1)
        ...
        if submitted:
            ...
            try:
                ...
                for i in range(26, iterations + 26):
                    ...
                    for field in ["environment", "assignedTo", "executedBy"]:
                        if field in df.columns:
                            ...
                            if pd.notna(val) and str(val).strip():
                                ...
                                # Convert username to JIRA ID if applicable
                                if field in ["assignedTo", "executedBy"]:
                                    clean_val = JIRA_USER_MAPPING.get(clean_val, clean_val)
